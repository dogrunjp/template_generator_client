import {
  ...
  isIndex_default,
  set_default
} from "./chunk-M2PGQ2IJ.js";
import {
  baseGet_default,
  get_default
} from "./chunk-TKK6SCBB.js";
import {
  ListCache_default,
  MapCache_default,
  Map_default,
...
cloneableTags[errorTag3] = cloneableTags[funcTag2] = cloneableTags[weakMapTag3] = false;
...
var countBy = createAggregator_default(function(result2, value, key) {
  if (hasOwnProperty12.call(result2, key)) {
    ++result2[key];
  } else {
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto15[key]) && !hasOwnProperty13.call(object, key)) {
...
var nativeObjectToString = objectProto18.toString;
...
var nativeObjectToString2 = objectProto19.toString;
var invertBy = createInverter_default(function(result2, value, key) {
  if (value != null && typeof value.toString != "function") {
    value = nativeObjectToString2.call(value);
  }
  if (hasOwnProperty16.call(result2, value)) {
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto21[key]) && !hasOwnProperty18.call(object, key)) {
    return srcValue;
  }
  return objValue;
}
...
function template(string, options, guard) {
  ...
  var sourceURL = hasOwnProperty19.call(options, "sourceURL") ? "//# sourceURL=" + (options.sourceURL + "").replace(/\s/g, " ") + "\n" : "";
  ...
  source += "';\n";
  var variable = hasOwnProperty19.call(options, "variable") && options.variable;
  if (!variable) {
    source = "with (obj) {\n" + source + "\n}\n";
...
mixin2(wrapperLodash_default, function() {
  ...
  baseForOwn_default(wrapperLodash_default, function(func, methodName) {
    if (!hasOwnProperty20.call(wrapperLodash_default.prototype, methodName)) {
...
baseForOwn_default(LazyWrapper_default.prototype, function(func, methodName) {
  ...
  if (lodashFunc) {
    ...
    if (!hasOwnProperty20.call(realNames_default, key)) {
